...
| Release et documentation #23                       | #28 Paramétrer la génération de release et gérer la documentation, <br/>#34 Création automatique d'une release, <br/>#35 Création de la documentation pour l'installation                                                                | Terminé         |                                                                                                                                                                                                                                                                                                                                                                                            |
...
TODO ajouter une colonne complexité ? Ou ajouter des commentaires ?
...
Nous pouvons observer que nous avons un total de 73% de notre code qui est couvert par les tests, ce qui n'est ni excellent, ni mauvais. Nous aurions pu produire plus de tests afin d'augmenter le coverage, mais le temps nous a fait défaut.

![Coverage commands](Image/cov_commands.png)

Dans le package commands, on observe que c'est principalement Serve qui manque de tests. Cela est dû au fait que nous ne savions pas vraiment comment tester l'accessibilité du site après avoir fait appel à Serve.
...
* Processus pas toujours respecté (assignation, utilisation du template pour les issues, format de la PR, messages de commit, estimations de temps + temps réel) => manque de discipline aussi du au fait qu'on a pas beaucoup de temps et qu'on a un peu délaissé le projet vers la fin
* Reviews pas toujours assidus
* Tache qu'il nous reste à faire, pourquoi on l'a pas fait (publish)
* Commentaire sur le fait que sur la fin on a été beaucoup plus régulier sur les estimations de temps, que c'était quasi systématique
* Test-first programming TODO bs avec du pseudocode ? Ou dire la vérité ?
* Manque de régularité dans les commits, de nouveau toujours lié à la charge de travail des autres cours

## Manuel utilisateur

TODO màj le manuel utilisateur