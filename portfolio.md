...
| Nous avons tendance à séparer les stories en taches trop petites         | Discuter après coup, réorganiser la séparation des stories en moins de taches | La séparation en taches est complexe, mais avec un peu de communication cela devient plus facile                |
 | la cicd ne fonctionne pas sur windows, à cause de la gestion des chemins | Run les tests uniquement sur windows et mac                                   | Faire plus attention avec les exemples afin qu'il soit platforme agnostique                                     |
